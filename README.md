...
![MSP Toolkit Interface](https://via.placeholder.com/800x600.png?text=Screenshot+Coming+Soon)
...
1. Download `ITAssist.ps1` from the [Releases](https://github.com/GarethMSheldon/TheMSPToolkit/releases) page
...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/GarethMSheldon/TheMSPToolkit/main/ITAssist.ps1" -OutFile "$env:TEMP\ITAssist.ps1"
& "$env:TEMP\ITAssist.ps1"
```
...
A: The tool is designed for Windows 10 and newer. Some features may work on Windows 8.1, but it's not officially supported.
