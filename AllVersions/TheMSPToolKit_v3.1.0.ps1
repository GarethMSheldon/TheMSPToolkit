...
# Include release notes for this snapshot (from change_3.1.0.ps1)
if (Test-Path (Join-Path $PSScriptRoot 'change_3.1.0.ps1')) { . (Join-Path $PSScriptRoot 'change_3.1.0.ps1') }
