...
Create-Btn "Find Top 5 Network Consuming Processes" "LightBlue" {
    try {
        ...
        $stats = Get-NetTCPConnection -ErrorAction Stop | Group-Object -Property OwningProcess | 
        ...
        Log "Network monitoring unavailable (requires Windows 8+): $($_.Exception.Message)" "WARN"
        Log "Using alternative method..."
        netstat -ano | Select-String "ESTABLISHED" | Select-Object -First 10 | ForEach-Object { Log $_.Line }
    }
}
