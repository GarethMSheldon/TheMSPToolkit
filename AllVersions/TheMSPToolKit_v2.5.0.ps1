...
<#
.SYNOPSIS
MSP Technician Toolkit — v2.5.0 snapshot
.DESCRIPTION
Toolkit snapshot for v2.5.0 with M365 helpers and update/reset tools.
.NOTES
...
# Include release notes for this snapshot (from change_2.5.0.ps1)
...
$form.Text = "MSP Technician IDE - v2.5.0 (Running as Admin)"
...
# Include typical v2 sections and M365 helpers (OneDrive, Outlook, mapped drives)
...
Create-Btn "OneDrive Reset" "White" {
...
# (rest of UI mirrors v2.0 functions)
